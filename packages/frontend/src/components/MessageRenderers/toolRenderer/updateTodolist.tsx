...
const UpdateTodolistRenderer: React.FC<ToolRendererProps<"updateTodolist">> = ({
  params,
  updateTime,
}) => {
  // 解析 markdown checklist，容错处理
  const parseChecklist = (markdown: string | undefined) => {
    ...
    try {
      ...
      console.error("[UpdateTodolistRenderer] Failed to parse checklist:", error);
      return [];
    }
  };
...
export default UpdateTodolistRenderer;
